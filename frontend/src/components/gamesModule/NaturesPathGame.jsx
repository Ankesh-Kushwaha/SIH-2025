...
// --- The Story Data ---
// This object defines the entire game. Each key is a scene.
const storyData = {
  start: {
    ...
    image: 'https://images.unsplash.com/photo-1501854140801-50d01698950b?auto=format&fit=crop&w=1350',
    choices: [
      { text: "Begin the hike", nextScene: 'meadow' }
    ]
  },
  meadow: {
    text: "You enter a meadow filled with colorful wildflowers. A particularly beautiful blue flower catches your eye.",
    image: 'https://images.unsplash.com/photo-1494951421735-a45a3a1f4965?auto=format&fit=crop&w=1350',
    choices: [
      {
        text: "Take a photo of it",
        nextScene: 'fallenBird',
        effect: { score: 5, message: "A beautiful memory, captured harmlessly." }
      },
      {
        text: "Pick the flower",
        nextScene: 'fallenBird',
        effect: { score: -10, message: "It looks nice, but now the bees and butterflies can't use it." }
      }
    ]
  },
  fallenBird: {
    text: "Further up the path, you see a tiny baby bird on the ground that has fallen from its nest.",
    image: 'https://images.unsplash.com/photo-1550866038-d2383c27d383?auto=format&fit=crop&w=1350',
    choices: [
      {
        text: "Leave it alone. The parent is likely nearby.",
        nextScene: 'streamCrossing',
        effect: { score: 15, message: "Wise choice! As you walk away, you see the mother bird return." }
      },
      {
        text: "Try to put it back in the nest.",
        nextScene: 'streamCrossing',
        effect: { score: -10, message: "Though your heart was in the right place, your scent could make the parents abandon the nest." }
      },
      {
        text: "Take it with you to 'save' it.",
        nextScene: 'streamCrossing',
        effect: { score: -15, message: "Removing wildlife is almost never the right answer. It will likely not survive without its parents." }
      }
    ]
  },
  streamCrossing: {
    text: "The path is blocked by a wide, rushing stream. The other side is just a short distance away.",
    image: 'https://images.unsplash.com/photo-1505963721598-522617596a28?auto=format&fit=crop&w=1350',
    choices: [
      {
        text: "Throw rocks in the stream to make a path.",
        nextScene: 'summit',
        effect: { score: -20, message: "You made it across, but disturbed the delicate stream ecosystem." }
      },
      {
        text: "Hike upstream to find a safer crossing.",
        nextScene: 'summit',
        effect: { score: 10, message: "Patience pays off. You found a fallen log and crossed without a trace." }
      }
    ]
  },
  summit: {
    ...
    image: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=1350',
    choices: [
      { text: "See your result", nextScene: 'end' }
    ]
  },
  endGood: {
    ...
    image: 'https://images.unsplash.com/photo-1454496522488-7a8e488e8606?auto=format&fit=crop&w=1350',
    choices: [
  ...
  endBad: {
    ...
    image: 'https://images.unsplash.com/photo-1582235940938-1db259a43aeb?auto=format&fit=crop&w=1350',
    choices: [
...
function NaturesPathGame() {
  ...
  const handleChoice = (choice) => {
    ...
    // Reset the game if starting over
    ...
    if (choice.effect) {
      ...
      setMessage(''); // Clear message if there's no effect
    }
